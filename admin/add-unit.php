...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        input[type="file"] { padding: 12px; background: white; cursor: pointer; }
    ...
    <main class="main-wrapper">
        <header class="topbar">
            ...
            <div class="topbar-right">
                <a href="manage-units.php" class="btn-back"><i class="fa-solid fa-arrow-left"></i> Cancel Listing</a>
            </div>
        </header>
        ...
        <div class="content-area">
            <div class="form-container fade-slide-up">
                <div class="form-header">
                    <h2>New Unit Specification</h2>
                    <p>Add a new staycation property to your live inventory.</p>
                </div>

                <form action="process-add-unit.php" method="POST" enctype="multipart/form-data">

                    <div class="form-group">
                        <label><i class="fa-solid fa-tag" style="margin-right: 5px; color: var(--amari-tan);"></i> Property Title</label>
                        <input type="text" name="title" required placeholder="e.g. Amari Penthouse">
                    </div>

                    <div class="form-row form-group">
                        <div class="form-group">
                            <label><i class="fa-solid fa-peso-sign" style="margin-right: 5px; color: var(--amari-tan);"></i> Price / Night</label>
                            <input type="number" step="0.01" name="price" required placeholder="2500.00">
                        </div>
                        <div class="form-group">
                            <label><i class="fa-solid fa-toggle-on" style="margin-right: 5px; color: var(--amari-tan);"></i> Initial Status</label>
                            <select name="status">
                    ...
                    <div class="form-group" style="margin-top: 25px;">
                        ...
                        <input type="text" name="amenities" placeholder="e.g. WiFi, Infinity Pool, Gym, Netflix">
                    </div>

                    <div class="form-group">
                        <label><i class="fa-solid fa-align-left" style="margin-right: 5px; color: var(--amari-tan);"></i> Detailed Description</label>
                        <textarea name="description" rows="5" required placeholder="Describe the luxury experience..."></textarea>
                    </div>
                    
                    <div class="form-group">
                        <label><i class="fa-regular fa-image" style="margin-right: 5px; color: var(--amari-tan);"></i> Property Image (Optional)</label>
                        <input type="file" name="image" accept="image/*">
                    </div>

                    <button type="submit" class="btn-save"><i class="fa-solid fa-plus" style="margin-right: 8px;"></i> Publish Property</button>
                </form>
            </div>
        </div>
    </main>
